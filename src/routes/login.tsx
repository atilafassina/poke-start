...
import { loginOrRegister, redirectIfLoggedIn } from '~/lib/auth'
...
export default function Login(props: RouteSectionProps) {
  ...
  return (
    <main class="mx-10 sm:mx-30 md:mx-50 lg:mx-80 xl:mx-80 space-y-2 my-10">
      {/* <Title>Login/Register | SolidDex </Title> */}
      <h2 class="font-bold text-3xl mb-4 text-center">Sign in to SolidDex</h2>
      <form
